 ...
 * <p>
 * Gestiona la persistencia de las votaciones realizadas por los usuarios.
 * Además de las operaciones CRUD heredadas de {@link JpaRepository}, incluye:
 * <ul>
...
public interface VotoRepository extends JpaRepository<Voto, Long> {
     ...
     * <p>
     * Este método  se utiliza para imponer la regla de negocio de
     ...
     * <p>
     * Utiliza una consulta JPQL con la función de agregación {@code AVG}
     ...
     * <p>
     * <b>Optimización:</b> Esta consulta no recupera las entidades completas de {@code Voto} ni de {@code Cuadro}.
